...
def _preprocess_config_from_args(args: argparse.Namespace) -> PreprocessConfig:
    return PreprocessConfig(
        ...
        ots_buffer_days=getattr(args, "ots_buffer_days", None),
        fpsd_buffer_days=getattr(args, "fpsd_buffer_days", None),
        ship2_buffer_days=getattr(args, "ship2_buffer_days", None),
